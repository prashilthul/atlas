    ...
    rows = await db.execute(
        text("""
            SELECT
                ...
                COUNT(*) FILTER (WHERE name = 'query_rewrite') AS rewrite_count,
                COUNT(*) FILTER (WHERE name = 'vector_search') AS search_count,
                COUNT(*) FILTER (WHERE name = 'lexical_search') AS lexical_count,
                ...
                AVG(duration_ms) FILTER (WHERE name = 'query_rewrite') AS avg_rewrite_ms,
                AVG(duration_ms) FILTER (WHERE name = 'vector_search') AS avg_search_ms,
                AVG(duration_ms) FILTER (WHERE name = 'lexical_search') AS avg_lexical_ms,
